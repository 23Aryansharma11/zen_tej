...
export default function Home() {
  return (
    <section className="relative flex flex-col-reverse md:flex-row items-center justify-between min-h-screen px-6 md:px-16 py-12 overflow-hidden">
      {/* Text Section */}
      <div className="relative z-10 w-full md:w-1/2 flex flex-col items-start gap-6 text-center md:text-left">
